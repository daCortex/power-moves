...
export const defaultContent: SiteContent = {
  ...
  products: {
    ...
    items: [
      { code: "PM-TX", name: "Power Transformers", tag: "Up to 230 kV / 150 MVA", blurb: "Power and distribution transformers built and type-tested in our Yangon facility — from compact distribution units to transmission class.", specs: [{ l: "Voltage", v: "Up to 230 kV" }, { l: "Capacity", v: "Up to 150 MVA" }, { l: "Type", v: "Oil-immersed / cast-resin" }, { l: "Standard", v: "IEC 60076 · DEKRA / KERI" }, { l: "Cooling", v: "ONAN / ONAF" }] },
      { code: "PM-MV", name: "Medium-Voltage Switchgear", tag: "ABB-licensed · up to 40.5 kV", blurb: "ABB-licensed metal-clad switchgear and ring main units for substation and primary distribution networks.", specs: [{ l: "Voltage", v: "12 / 24 / 40.5 kV" }, { l: "Short-circuit", v: "31.5 kA" }, { l: "Construction", v: "Metal-clad" }, { l: "Technology", v: "ABB-licensed" }, { l: "Class", v: "Internal-arc" }] },
