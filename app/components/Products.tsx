  ...
  return (
    <section id="products" className="scroll-mt-28 border-b border-line-strong/15 bg-paper">
      <div className="mx-auto max-w-[88rem] px-6 py-20 md:py-28">
        ...
        <Reveal delay={0.1}>
          <div className="mt-12 grid gap-px border border-line-strong/15 bg-line-strong/15 lg:grid-cols-[1.3fr_1fr]">
            {/* Product selector grid */}
            <div className="grid grid-cols-2 gap-px bg-line-strong/15 sm:grid-cols-3">
              {PRODUCTS.map((prod, i) => {
                const on = i === active;
                return (
                  <button
                    ...
                    className={`group flex flex-col justify-between p-5 text-left transition-colors ${
            ...
            <div className="relative overflow-hidden bg-surface">
                ...
                >
                  <div className="flex items-center justify-between border-b border-line-strong/15 pb-4">
                  ...
                  <dl className="mt-6 border-t border-line-strong/15">
                    {p.specs.map((s) => (
                  ...
                  <a
                    href="#contact"
                    className="group mt-auto inline-flex items-center justify-center gap-3 bg-red px-6 py-3.5 tech-label text-white transition-colors hover:bg-ink"
                  >
